...
public interface JointAnimator<T> {
     ...
     * @param driverContainer      Data container from the previous tick
     */
    public abstract void extractAnimationData(T dataReference, DriverAnimationContainer driverContainer);

    /**
     * Calculates and returns an animation pose once per tick, after pose sampler update and animation data extraction
     * @param driverContainer      Data container containing extracted animation variable data.
     ...
     */
    public abstract AnimationPose calculatePose(DriverAnimationContainer driverContainer, PoseSamplerStateContainer poseSamplerStateContainer, JointSkeleton jointSkeleton, float partialTicks);
