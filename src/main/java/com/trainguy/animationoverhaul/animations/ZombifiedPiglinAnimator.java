...
public class ZombifiedPiglinAnimator extends LivingEntityAnimator<ZombifiedPiglin, PiglinModel<ZombifiedPiglin>> {
    ...
    public void setProperties(ZombifiedPiglin zombifiedPiglin, PiglinModel<ZombifiedPiglin> model, float tickProgress) {
        ...
        this.locatorRig.addLocatorModelPart(locatorLeftEar, locatorRightEar, this.model.leftEar);
        ...
        AnimationOverhaul.debugEntity = zombifiedPiglin;
    }
    ...
    private void addPoseLayerIdle(){
        AnimationData.TimelineGroup idleTimelineGroup = getTimelineGroup("idle_1");
    ...
    private void addPoseLayerWalk(){
        AnimationData.TimelineGroup walkTimelineGroup = getTimelineGroup("walk_1");
    ...
    protected void finalizeModel() {
        ...
        this.model.leftEar.x += 5;
        this.model.leftEar.y -= 6;
