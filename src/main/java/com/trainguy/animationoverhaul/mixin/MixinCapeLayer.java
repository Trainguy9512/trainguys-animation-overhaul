...
public class MixinCapeLayer {
    ...
    private void removeCapeTranslate(PoseStack instance, double d, double e, double f){
    ...
    private void removeCapeRotation(PoseStack instance, Quaternion quaternion){
